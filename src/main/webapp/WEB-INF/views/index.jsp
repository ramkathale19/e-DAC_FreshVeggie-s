...
<nav class="navbar navbar-inverse ">
  <div class="container-fluid">
    <div class="navbar-header">
     ...
     <div class="navbar-header">
      <a class="navbar-brand" >	Fresh Veggie's</a>
    </div>
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="user/login"><span class="glyphicon glyphicon-log-in-admin"></span>Admin Login</a></li>
	
    </ul>
  </div>
</nav>
<div>
<!-- <img src="newFruits.jpg" alt="FRESHHHH" width="1000" height="1000"> -->
 <img src="fruits.jpeg" alt="Los Angeles" style="width:100% ;" >
 </div>
  ...
  <div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item">
        <img src="All-Fresh-Fruit.jpg" alt="Chicago" style="width:100%;" >
         <div class="carousel-caption">
      ...
      <div class="item">
        <img src="newFruits.jpg" alt="New york" style="width:100%;" >
         <div class="carousel-caption">
